...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (response.ok) {
                await interaction.editReply(`Test webhook sent successfully!\n**Type:** ${eventType}\n**Status:** ${response.status} ${response.statusText}`);
            } else {
                await interaction.editReply(`Failed to send test webhook.\n**Status:** ${response.status} ${response.statusText}`);
            }
        } catch (error) {
            await interaction.editReply(`Error sending test webhook: ${error.message}`);
        }
    },
};
